...
from ..serializer import TalukSerializer,BulkTalukCreateSerializer
from django.http import Http404

modelName = "Taluk"
notFound = "Taluk not found"
ModelName = Taluk
SerializerName = TalukSerializer
BulkSerialzier = BulkTalukCreateSerializer


class TaulkList(APIView):
...
class BulkTalukCreateView(APIView):
    def post(self, request):
...
class DeleteAllTalukView(APIView):
    def delete(self, request):
        ...
        return Response(
            {
                "message": "All Taluks have been deleted successfully.",
