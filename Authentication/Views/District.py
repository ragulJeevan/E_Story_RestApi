...
from ..serializer import DistrictSerializer,BulkDistrictCreateSerializer
from django.http import Http404

modelName = "District"
notFound = "District not found"
ModelName = District
SerializerName = DistrictSerializer
BulkSerialzier = BulkDistrictCreateSerializer
...
class BulkDistrictCreateView(APIView):
    def post(self, request):
...
class DeleteAllDistrictView(APIView):
    def delete(self, request):
        ...
        return Response(
            {
                "message": "All Districts have been deleted successfully.",
